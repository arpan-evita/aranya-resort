         ...
         {isLoading ? (
           <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-6 lg:gap-8">
             ...
             <div className="lg:col-span-5 flex flex-col gap-6">
               {[1, 2, 3].map((i) => (
                 <div key={i} className="flex gap-5 items-center p-4">
          ...
          >
              ...
              <div className="relative overflow-hidden rounded-3xl aspect-[4/3] lg:aspect-[16/12]">
                       {displayExperiences[0].image_url ? (
                         <img
                           src={displayExperiences[0].image_url}
                           alt={displayExperiences[0].name}
          ...
          <div className="lg:col-span-5 flex flex-col gap-6 lg:gap-8">
               {displayExperiences.slice(1).map((experience, index) => (
              <motion.div
                   key={experience.id}
                initial={{ opacity: 0, y: 40 }}
                animate={isInView ? { opacity: 1, y: 0 } : {}}
