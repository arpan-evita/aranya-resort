...
export function AboutSnippet() {
  ...
  return (
    <section ref={ref} className="py-24 md:py-32 lg:py-40 bg-background relative overflow-hidden">
      ...
      <div className="luxury-container relative">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
            ...
            <div className="relative">
              ...
              <div className="relative rounded-3xl overflow-hidden shadow-luxury">
                <div className="aspect-[4/5]">
                  <img
                    src={villaImage}
                    alt="Luxury villa interior at Aranya"
          ...
          >
            ...
            <Link 
              to="/about" 
              className="group inline-flex items-center gap-3 text-forest font-medium hover:text-gold transition-colors"
            >
