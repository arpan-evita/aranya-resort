    ...
    <section className="relative h-screen min-h-[800px] flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute left-4 md:left-8 top-1/2 -translate-y-1/2 z-30">
        <button
          ...
          className="group w-12 h-12 md:w-14 md:h-14 rounded-full border border-ivory/30 hover:border-gold hover:bg-gold/10 flex items-center justify-center transition-all duration-300 backdrop-blur-sm"
        ...
        {slides.map((_, index) => (
          <button
            ...
            className={`relative h-1 rounded-full transition-all duration-500 overflow-hidden ${
              index === currentSlide ? "w-12 bg-gold" : "w-6 bg-ivory/30 hover:bg-ivory/50"
            }`}
