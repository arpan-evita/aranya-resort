    ...
    <>
      <motion.header
        ...
        className={`fixed top-0 left-0 right-0 z-50 transition-all duration-700 ${
          isScrolled
            ? "bg-ivory/98 backdrop-blur-lg shadow-medium py-0"
        ...
        <div className="max-w-7xl mx-auto px-3 sm:px-4 lg:px-6">
          <nav className="flex items-center justify-between h-20 md:h-24">
            ...
            <Link to="/" className="flex flex-col group shrink-0">
              <span
                className={`font-serif text-xl md:text-2xl font-semibold tracking-tight transition-all duration-500 ${
              ...
              <span
                className={`font-serif text-[9px] md:text-[10px] uppercase tracking-[0.15em] transition-colors duration-500 ${
            ...
            <div className="hidden lg:flex items-center gap-3 shrink-0">
              <a
                ...
                className={`flex items-center gap-2 px-4 py-2 rounded-full text-sm font-medium transition-all duration-300 ${
                  isScrolled
                    ? "text-forest hover:text-gold hover:bg-gold/5"
                    : "text-ivory/90 hover:text-gold-light hover:bg-ivory/10"
                }`}
              >
              ...
              <Button 
                variant={isScrolled ? "luxuryDark" : "luxury"} 
                size="sm" 
                asChild
                className="shadow-lg"
              >
      ...
      <AnimatePresence>
        {isMobileMenuOpen && (
          ...
          >
            <div
              className="absolute inset-0 bg-forest-deep/95 backdrop-blur-md"
